...
void MyBank::Trata(int N) {
    ...
    if (tempBalance > BALANCE[N]) {
        ...
        BALANCE[N] -= tempBalance;
        char* temp = new char;//äëÿ ââîäà íîâîé êàòåãîðèè
        int cat;//äëÿ âûáîðà ê êàêîé êàòåãîðèè îòíåñòè
...
void MyBank::SaveToFile() {                                                                                                               
    //íóæíî ÷òîáû îáÿçàòåëüíî ôàéë ïî ýòîìó ïóòè áûë                                                                                             
    //èíà÷å íèêóäà íå ñîõðàíèòüñÿ                                                                                                               
    //òàê ñäåëàíî íå ïîòîìó ÷òî ÿ ëåíèâûé                                                                                                    
    //à ïîòîìó ÷òî ýòî íå ìíå íóæíî ñîõðàíÿòü êóäà òî                                                                                
    //à êëèåíòó :)                                                                                                                          
    ofstream out;// ïîòîê äëÿ çàïèñè                                                                                                          
    out.open("E:\\Test\\test.txt"); // îêðûâàåì ôàéë äëÿ çàïèñè                                                                              
    if (out.is_open()) {                                                                                                                  
        for (int i = 0; i <= N; i++) {                                                                                                   
            if(CateTop[i].empty())                                                                                                        
        ...
        }out << "Ïîäïèñûâàéòåñü íà èíñòàãðàì*(çàïðåùåííàÿ â ðô ñîöñåòü) dweavp!!!";
    }
    out.close();
}
void MyBank::Exit() {
